...
//		Machine.interrupt().restore(status);
	...
	public static void finish() {
		...
		lock.acquire();
		KThread currThread = currentThread.jQueue.nextThread();
		while (currThread != null) {
			//currentThread.jQueue.acquire(currThread);
			currThread.ready();
			currThread = currentThread.jQueue.nextThread();
			
		}
		//currentThread.done.wakeAll();
		//currentThread.jQueue = null;
		lock.release();
